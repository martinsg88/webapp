<%@ Page Title="Remove" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master"
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>
        ...
        <asp:GridView ID="GridView1" runat="server" AllowSorting="True" 
            ...
            EmptyDataText="There are no data records to display." style="margin-left: 0px">
